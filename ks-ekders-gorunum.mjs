...
t("gunlukTablo birebir ders-hücre gövdesi (hucreIcerik) aynen", gunlukBolge.includes('var hucreIcerik = sinif || esc(ders.ogrenciAd || "").split(" ")[0];'));
t("gunlukTablo grup satırı (grupUyelerG) aynen", gunlukBolge.includes("var grupUyelerG = grupUyeEtiketleri(ders);"));
t("gunlukTablo altYazi birleşimi aynen", gunlukBolge.includes('join(" · ") + (dersBilgi ? " · " : "")'));
