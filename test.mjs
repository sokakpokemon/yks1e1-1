...
if (dusenler.length === 0) {
  ...
  console.log(`MANIFEST: ${suites.length} süit, toplam ${manifestToplam} beklenen | RUNNER: ${toplamTest} koşan, ${toplamGecen} geçen — ${manifestToplam === toplamTest && toplamGecen === toplamTest ? "BİREBİR EŞİT ✓" : "EŞİTSİZLİK ✗"}`); /* DÖNGÜ-28: sabit '49' → suites.length (50) */
