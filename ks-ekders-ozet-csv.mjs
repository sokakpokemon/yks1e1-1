...
t("gunlukTablo kodu değişmedi", sha(blok("function gunlukTablo() {")) === sha(bakBlok(bakKaynak, "function gunlukTablo() {")));
t("haftalikOgrtTablo kodu değişmedi", sha(blok("function haftalikOgrtTablo() {")) === sha(bakBlok(bakKaynak, "function haftalikOgrtTablo() {")));
