...
if (dusenler.length === 0) {
  ...
  console.log(`MANIFEST: 48 süit, toplam ${manifestToplam} beklenen | RUNNER: ${toplamTest} koşan, ${toplamGecen} geçen — ${manifestToplam === toplamTest && toplamGecen === toplamTest ? "BİREBİR EŞİT ✓" : "EŞİTSİZLİK ✗"}`);
